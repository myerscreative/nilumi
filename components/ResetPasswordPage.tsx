              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-slate-950/50 border border-slate-800 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-[#a3cf4a]/50 focus:ring-1 focus:ring-[#a3cf4a]/20 transition-all font-medium placeholder-slate-600 pr-10"
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-500 hover:text-[#a3cf4a] transition-colors p-1"
                  >
                    {showPassword ? (
